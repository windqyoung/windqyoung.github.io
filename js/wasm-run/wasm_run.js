 ...
 * @param {string} text
 */
export function append_element(text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    wasm.append_element(ptr0, len0);
}
...
export function sha512(data) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.sha512(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_alert_b68440936682a896 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_run_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
